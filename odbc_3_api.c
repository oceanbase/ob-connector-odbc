    ...
    SQLSMALLINT *StringLength2Ptr)
{
  ...
  SQLRETURN ret;
  MDBUG_C_ENTER(Connection, "SQLBrowseConnect");
  if (!Connection)
    return SQL_INVALID_HANDLE;
  //MADB_SetError(&Dbc->Error, MADB_ERR_IM001, NULL, 0);
  //ret= Dbc->Error.ReturnValue;
  ret = Connection->Methods->BrowseConnect(ConnectionHandle, InConnectionString, StringLength1, OutConnectionString, BufferLength, StringLength2Ptr, FALSE);
    ...
    SQLSMALLINT *StringLength2Ptr)
{
  MADB_Dbc *Connection = (MADB_Dbc *)ConnectionHandle;
  SQLRETURN ret;
  MDBUG_C_ENTER(Connection, SQLBrowseConnectW);
  if (!Connection)
    return SQL_INVALID_HANDLE;

  SQLULEN CpLength1, CpLength2;
  char *StrInConnection = NULL;

  StrInConnection = MADB_ConvertFromWChar((const SQLWCHAR *)InConnectionString, StringLength1, &CpLength1, Connection->ConnOrSrcCharset, NULL);

  ret = Connection->Methods->BrowseConnect(ConnectionHandle, StrInConnection, CpLength1, OutConnectionString, BufferLength, StringLength2Ptr, TRUE);

  MADB_FREE(StrInConnection);
...
SQLRETURN SQL_API SQLCloseCursor(SQLHSTMT StatementHandle)
{
  ...
  if (IsStmtNossps(Stmt)){
    if (!Stmt->result2 ||(!StmtFieldCount(Stmt) && Stmt->Connection->Environment->OdbcVersion >= SQL_OV_ODBC3))
    {
    ...
    if (!Stmt->stmt || (!mysql_stmt_field_count(Stmt->stmt) && Stmt->Connection->Environment->OdbcVersion >= SQL_OV_ODBC3)) {
      MADB_SetError(&Stmt->Error, MADB_ERR_24000, NULL, 0);
      ret = Stmt->Error.ReturnValue;
    } else {
      ret = Stmt->Methods->StmtFree(Stmt, SQL_CLOSE);
	...
	SQLLEN * pfDesc)
{
  ...
  MDBUG_C_ENTER(Stmt->Connection, "SQLColAttributes");
    ...
    SQLSMALLINT NameLength4)
{
  ...
  MDBUG_C_ENTER(Stmt->Connection, "SQLColumnsW");
    ...
    SQLSMALLINT *NullablePtr)
{
  ...
  MDBUG_C_ENTER(Stmt->Connection, "SQLDescribeParam");
    ...
    SQLINTEGER *StringLengthPtr)
{
  ...
  MDBUG_C_ENTER(Dbc, "SQLGetConnectAttrW");
  MDBUG_C_DUMP(Dbc, Attribute, d);
  MDBUG_C_DUMP(Dbc, ValuePtr, 0x);
  MDBUG_C_DUMP(Dbc, BufferLength, d);
  MDBUG_C_DUMP(Dbc, StringLengthPtr, 0x);
...
SQLRETURN SQL_API SQLGetConnectOption(SQLHDBC ConnectionHandle, SQLUSMALLINT Option, SQLPOINTER ValuePtr)
{
  ...
  MDBUG_C_ENTER(Dbc, "SQLGetConnectOption");
...
SQLRETURN SQL_API SQLGetConnectOptionW(SQLHDBC ConnectionHandle, SQLUSMALLINT Option, SQLPOINTER ValuePtr)
{
  ...
  MDBUG_C_ENTER(Dbc, "SQLGetConnectOptionW");
     ...
     SQLSMALLINT *   NameLengthPtr)
{
  ...
  MDBUG_C_ENTER(Stmt->Connection, "SQLGetCursorName");
     ...
     SQLSMALLINT *   NameLengthPtr)
{
  ...
  MDBUG_C_ENTER(Stmt->Connection, "SQLGetCursorNameW");
    ...
    SQLLEN *StrLen_or_IndPtr)
{
  ...
  MDBUG_C_ENTER(Stmt->Connection, "SQLGetData");

  if (StrLen_or_IndPtr)
    MDBUG_C_DUMP(Stmt->Connection, *StrLen_or_IndPtr, d);
  ...
  if (IsStmtNossps(Stmt)) {
    if (Stmt->result2 == NULL || Stmt->row2 == NULL || Stmt->fields2==NULL || Stmt->lengths2 == NULL){
      return MADB_SetError(&Stmt->Error, MADB_ERR_HY000, "Nossps result2/row2/fields2/lengths2 error!", 0);
    }
  }

  if (Col_or_Param_Num > StmtFieldCount(Stmt))
  {
  ...
  for (i=0; i < StmtFieldCount(Stmt); i++)
  {
  ...
  ret = Stmt->Methods->GetData(StatementHandle, Col_or_Param_Num, TargetType, TargetValuePtr, BufferLength, StrLen_or_IndPtr, FALSE);
  MDBUG_C_RETURN(Stmt->Connection, ret, &Stmt->Error);
}
/* }}} */
    ...
    SQLSMALLINT *NullablePtr)
{
  ...
  MDBUG_C_ENTER(Desc->Dbc, "SQLGetDescRec");
    ...
    SQLSMALLINT *NullablePtr)
{
 MADB_Desc *Desc= (MADB_Desc *)DescriptorHandle;
  ...
  MDBUG_C_ENTER(Desc->Dbc, "SQLGetDescRecW");
    ...
    SQLINTEGER *StringLengthPtr)
{
  ...
  MDBUG_C_ENTER(Stmt->Connection, "SQLGetStmtAttrW");
    ...
    SQLSMALLINT DataType)
{
  ...
  MDBUG_C_ENTER(Stmt->Connection, "SQLGetTypeInfo");

  ret = MADB_GetTypeInfo(Stmt, DataType);
  MDBUG_C_RETURN(Stmt->Connection, ret, &Stmt->Error);
}
/* }}} */
    ...
    SQLSMALLINT DataType)
{
  ...
  MDBUG_C_ENTER(Stmt->Connection, "SQLGetTypeInfoW");
...
SQLRETURN SQL_API SQLMoreResults(SQLHSTMT StatementHandle)
{
  ...
  MDBUG_C_ENTER(Stmt->Connection, "SQLMoreResults");

  ret = MADB_StmtMoreResults(Stmt);
  MDBUG_C_RETURN(Stmt->Connection, ret, &Stmt->Error);
}
/* }}} */
    ...
    SQLINTEGER *TextLength2Ptr)
{
  ...
  MDBUG_C_ENTER(Conn, "SQLNativeSqlW");
    ...
    SQLSMALLINT *ParameterCountPtr)
{
  ...
  MDBUG_C_ENTER(Stmt->Connection, "SQLNumParams");

  ret = Stmt->Methods->ParamCount(Stmt, ParameterCountPtr);
    ...
    SQLSMALLINT *ColumnCountPtr)
{
  ...
  MDBUG_C_ENTER(Stmt->Connection, "SQLNumResultCols");

  ret = Stmt->Methods->ColumnCount(Stmt, ColumnCountPtr);

  if (ColumnCountPtr)
  {
    MDBUG_C_PRINT(Stmt->Connection, "--SQLNumResultCols::ColumnCountPtr,%d", *ColumnCountPtr);
  }
    ...
    SQLPOINTER *ValuePtrPtr)
{
  ...
  MDBUG_C_ENTER(Stmt->Connection, "SQLParamData");

  ret = Stmt->Methods->ParamData(Stmt, ValuePtrPtr);
    ...
    SQLSMALLINT NameLength4)
{
  MADB_Stmt *Stmt= (MADB_Stmt *)StatementHandle;
  SQLRETURN ret;
  MDBUG_C_ENTER(Stmt->Connection, "SQLProcedureColumns");

  if (!Stmt)
    return SQL_INVALID_HANDLE;
  MADB_CLEAR_ERROR(&Stmt->Error);

  ret =  Stmt->Methods->ProcedureColumns(Stmt, (char *)CatalogName,NameLength1, (char *)SchemaName, NameLength2,
    ...
    SQLSMALLINT NameLength4)
{
  ...
  char *CpCatalog= NULL,
       ...
       *CpColumn= NULL;
  SQLULEN CpLength1= 0, CpLength2= 0, CpLength3= 0, CpLength4= 0;
  MDBUG_C_ENTER(Stmt->Connection, "SQLProcedureColumnsW");
    ...
    SQLSMALLINT NameLength3)
{
  ...
  MDBUG_C_ENTER(Stmt->Connection, "SQLProcedures");

  if (!Stmt)
    return SQL_INVALID_HANDLE;
  MADB_CLEAR_ERROR(&Stmt->Error);

  ret = Stmt->Methods->Procedures(Stmt, (char *)CatalogName, NameLength1, (char *)SchemaName, 
    ...
    SQLSMALLINT NameLength3)
{
  ...
  MDBUG_C_ENTER(Stmt->Connection, "SQLProceduresW");
    ...
    SQLLEN *RowCountPtr)
{
  ...
  MDBUG_C_ENTER(Stmt->Connection, "SQLRowCount");

  ret = Stmt->Methods->RowCount(Stmt, RowCountPtr);
    ...
    SQLSMALLINT NameLength)
{
  ...
  MDBUG_C_ENTER(Stmt->Connection, "SQLSetCursorName");
    ...
    SQLSMALLINT NameLength)
{
  ...
  MDBUG_C_ENTER(Stmt->Connection, "SQLSetCursorNameW");
    ...
    SQLINTEGER BufferLength)
{
  ...
  MDBUG_C_ENTER(Desc->Dbc, "SQLSetDescField");
    ...
    SQLINTEGER BufferLength)
{
  ...
  MDBUG_C_ENTER(Desc->Dbc, "SQLSetDescFieldW");
    ...
    SQLLEN *IndicatorPtr)
{
  ...
  if (Desc->Dbc)
    MDBUG_C_ENTER(Desc->Dbc, "SQLSetDescRec");

  //MADB_NOT_IMPLEMENTED(Desc);
  return MADB_DescSetRec(Desc, RecNumber, Type, SubType, Length, Precision, Scale, DataPtr, StringLengthPtr, IndicatorPtr, FALSE);
}
/* }}} */
    ...
    SQLLEN *IndicatorPtr)
{
  ...
  if (Desc->Dbc)
    MDBUG_C_ENTER(Desc->Dbc, "SQLSetDescRecW");

  //MADB_NOT_IMPLEMENTED(Desc);
  return MADB_DescSetRec(Desc, RecNumber, Type, SubType, Length, Precision, Scale, DataPtr, StringLengthPtr, IndicatorPtr, TRUE);
}
/* }}} */
                                      ...
                                      SQLUSMALLINT crowRowSet)
{
  ...
  MDBUG_C_ENTER(Stmt->Connection, "SQLSetScrollOptions");
