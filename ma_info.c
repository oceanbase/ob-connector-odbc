...
// TODO Need to be compatible with Oracle
MADB_TypeInfo TypeInfoOracle[]=
{
  {"BLOB",SQL_LONGVARBINARY,2147483647,"''","''","NULL",1,1,0,0,0,0,"BLOB",0,0,0,0,0, SQL_LONGVARBINARY,SQL_LONGVARBINARY},
  {"LONG RAW",SQL_LONGVARBINARY,2147483647,"''","''","NULL",1,0,0,0,0,0,"LONG RAW",0,0,0,0,0, SQL_LONGVARBINARY,SQL_LONGVARBINARY},
  {"BFILE",SQL_LONGVARBINARY,2147483647,"''","''","NULL",1,1,0,0,0,0,"BFILE",0,0,0,0,0, SQL_LONGVARBINARY,SQL_LONGVARBINARY},
  {"RAW",SQL_VARBINARY,2000,"''","''","'max length'",1,0,3,0,0,0,"RAW",0,0,0,0,0, SQL_VARBINARY,SQL_VARBINARY},
  {"CLOB",SQL_LONGVARCHAR,2147483647,"''","''","NULL",1,1,0,0,0,0,"CLOB",0,0,0,0,0, SQL_LONGVARCHAR,SQL_LONGVARCHAR},
  {"LONG",SQL_LONGVARCHAR,2147483647,"''","''","NULL",1,1,0,0,0,0,"LONG",0,0,0,0,0, SQL_LONGVARCHAR,SQL_LONGVARCHAR},
  {"CHAR",SQL_CHAR,2000,"''","''","'max length'",1,1,3,0,0,0,"CHAR",0,0,0,0,0, SQL_CHAR,SQL_CHAR},
  {"DECIMAL",SQL_DECIMAL,38,"","","'precision,scale'",1,0,3,0,0,0,"DECIMAL",0,38,0,0,10, SQL_DECIMAL,SQL_DECIMAL},
  {"BINARY_FLOAT",SQL_REAL,7,"","","NULL",1,0,3,0,0,0,"BINARY_FLOAT",0,0,0,0,10, SQL_REAL,SQL_REAL},
  {"BINARY_DOUBLE",SQL_FLOAT,15,"","","NULL",1,0,3,0,0,0,"BINARY_DOUBLE",0,0,0,0,10, SQL_FLOAT,SQL_FLOAT},
  {"DOUBLE PRECISION",SQL_DOUBLE,15,"","","NULL",1,0,3,0,0,0,"DOUBLE PRECISION",0,0,0,0,10, SQL_DOUBLE,SQL_DOUBLE},
  {"DATE",SQL_TYPE_TIMESTAMP,19,"''","''","NULL",1,0,3,0,0,0,"DATE",0,0,0,3,10, SQL_TYPE_TIMESTAMP,SQL_DATE},
  {"VARCHAR2",SQL_VARCHAR,4000,"''","''","'max length'",1,1,3,0,0,0,"VARCHAR2",0,0,0,3,10, SQL_VARCHAR,SQL_VARCHAR},
  {"NCHAR",SQL_WCHAR,1000,"N''","''","'max length'",1,1,3,0,0,0,"NCHAR",0,0,0,3,10, SQL_WCHAR,SQL_WCHAR},
  {"NVARCHAR2",SQL_WVARCHAR,2000,"N''","''","'max length'",1,1,3,0,0,0,"NVARCHAR2",0,0,0,3,10, SQL_WVARCHAR,SQL_WVARCHAR},
  {"NCLOB",SQL_WLONGVARCHAR,2147483647,"N''","''","NULL",1,1,0,0,0,0,"NCLOB",0,0,0,3,10, SQL_WLONGVARCHAR,SQL_WLONGVARCHAR},
  {NULL,0,0,NULL,NULL,NULL,0,0,0,0,0,0,NULL,0,0,0,0,0}
};
...
SQLRETURN MADB_GetTypeInfo(SQLHSTMT StatementHandle, SQLSMALLINT DataType)
{
  ...
  if(IS_ORACLE_MODE(Stmt)) {
     TypeInfo= TypeInfoOracle;
  }

  StmtStr[0]= 0;
  for (i=0;TypeInfo[i].TypeName; i++)
  {
    if (DataType == SQL_ALL_TYPES || TypeInfo[i].DataType == DataType)
    {
      if(isFirst)
      {
        isFirst= FALSE;
        p+= _snprintf(p, 8192 - strlen(StmtStr),
         ...
         if(IS_ORACLE_MODE(Stmt)) {
           p+= _snprintf(p, 8192 - strlen(StmtStr)," from dual ");
         }
      } else {
          p+= _snprintf(p, 8192 - strlen(StmtStr),
