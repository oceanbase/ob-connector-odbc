...
#define SQL_API_SQLEXECUTE_ASYNC		 1023
#define SQL_API_SQLGETASYNCCONNFD  1024
#define SQL_API_SQLENDTRAN_ASYNC   1025
#if (ODBCVER >= 0x0300)
...
SQLRETURN  SQL_API SQLCancelHandle(SQLSMALLINT HandleType, SQLHANDLE InputHandle);
    ...
    SQLRETURN  SQL_API SQLEndTranAsync(SQLSMALLINT HandleType, SQLHANDLE Handle,
                                  SQLSMALLINT CompletionType, int* status);
#endif
    ...
    // add for async interface 
    SQLRETURN  SQL_API SQLExecuteAsync(SQLHSTMT statement_handle, int* status);

    SQLRETURN  SQL_API SQLGetAsyncConnFd(SQLHDBC ConnectionHandle, int* fd);
