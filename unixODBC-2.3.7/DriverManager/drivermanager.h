...
#endif
#ifdef ODBC_DEBUG
    #define USE_ODBC_DEBUG 1
#else
    #define USE_ODBC_DEBUG 0
#endif
#ifdef HAVE_SYNCH_H
#include <synch.h>
#endif
...
#define DM_SQLEXECUTE_ASYNC               79
#define CHECK_SQLEXECUTE_ASYNC(con)       (con->functions[79].func!=NULL)
#define SQLEXECUTEASYNC(con,stmt, status)\
                                    (con->functions[79].func)(stmt, status)                                        
//SQLGetAsycConnFd
#define DM_SQLGETASYNCCONNFD              80
#define CHECK_SQLGETASYNCCONNFD(con)       (con->functions[80].func!=NULL)
#define SQLGETASYNCCONNFD(con,dbc, fd)\
                                    (con->functions[80].func)(dbc, fd) 
//SQLEndTranAsync
#define DM_SQLENDTRAN_ASYNC               81
#define CHECK_SQLENDTRAN_ASYNC(con)       (con->functions[81].func != NULL)
#define SQLENDTRANASYNC(con,ht,h,op, status)\
                                    (con->functions[81].func)(ht,h,op, status)                                 
#endif
