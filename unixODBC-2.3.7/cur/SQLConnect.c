...
static struct driver_func  cl_template_func[] =
{
    ...
    /* 78 */ { SQL_API_SQLCANCELHANDLE, "SQLCANCELHANDLE", NULL, NULL, 
                            NULL},
    /* 79 */ { SQL_API_SQLEXECUTE_ASYNC, "SQLExecuteAsync", NULL, NULL,
                            NULL },
    /* 80 */ { SQL_API_SQLGETASYNCCONNFD, "SQLGetAsycConnFd", NULL, NULL,
                            NULL},
    /* 81 */ { SQL_API_SQLENDTRAN_ASYNC, "SQLEndTranAsync", NULL, NULL,
                            NULL},
};
