...
size_t ma_fcvt2(double x, int precision, char *to, my_bool *error)
{
...
size_t ma_gcvt2(double x, int type, int width, char *to, my_bool *error)
{//type=0 float,1 double
  ...
  res= dtoa(x, 4, type == 1 ? width : MIN(width, FLT_DIG),
